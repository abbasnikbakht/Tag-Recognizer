...
from TagRecognizer24Nov_Cherry_files import mainProcess
...
class FileDemo(object):
    ...
    def upload(self, myFile,tid):
        ...
        #g.write(data)
        g.close()
        a = cv2.imread('outcherryfilesOCR.jpg') # changed from grayscale image
        #form = cgi.FieldStorage()
        #filename = form['myFile'].value
        print 'Hello ' + myFile.filename
        print 'outcherry file type is :',type(a)
        json_string, TesseractOCR = mainProcess(tid,a)
        
        return json_string, TesseractOCR
    upload.exposed = True
