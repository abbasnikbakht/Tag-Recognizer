...
print img.shape
img1 = cv2.imread('115_cut.jpg',0) 					# Read the image as GRAYSCALE
...
samples = np.loadtxt('HOGsamples2.data',np.float32)
responses = np.loadtxt('HOGresponses2.data',np.float32)
