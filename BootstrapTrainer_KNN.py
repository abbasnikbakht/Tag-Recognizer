...
img = cv2.imread('letters.tif')
print img.shape
img1 = cv2.imread('letters.tif',0) 					# Read the image as GRAYSCALE
...
np.savetxt('generalsamples0.data',samples)
#np.save('responses1.data',responses)
#np.savetxt('generalresponses1.data', responses, fmt="%s") 
np.savetxt('generalresponses0.data',responses)
